                ...
                <div class="container">
                    <header class="d-flex justify-content-center py-3">
                        <ul class="nav nav-pills">
                            ...
                            <div class="dropdown">
                                <a class="btn btn-pesanan" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Pesanan
                                </a>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{ url('toko') }}">Riwayat Pembayaran</a></li>
                                    <li><a class="dropdown-item" href="{{ url('toko') }}">Tagihan</a></li>
                                </ul>
                            </div> 
