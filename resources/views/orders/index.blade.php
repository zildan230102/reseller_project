                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu text-center" aria-labelledby="dropdownMenuButton">
                                    <li class="d-flex justify-content-around">
                                        <button class="btn-custom-warning mx-2" data-bs-toggle="modal" data-bs-target="#editOrderModal{{ $order->id }}">
                                            <i class="bi bi-pencil"></i>
                                        </button>
                                        <form id="deleteForm" action="" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" class="btn-custom-danger mx-2" data-bs-toggle="modal" data-bs-target="#deleteModal" data-order-id="{{ $order->id }}">
