                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu text-start p-2" aria-labelledby="dropdownMenuButton">
                                            <li>
                                                <button class="custom-dropdown-item no-border-item w-100" data-bs-toggle="modal"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 col-md-6 mb-3">
                                                        ...
                                                        <input type="number" class="form-control" name="berat"
                                                            value="{{ $buku->berat }}" step="0.01" min="0"
                                                            required>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" class="form-control" name="harga"
                                                        value="{{ $buku->harga }}" step="0.01" min="0"
                                                        required>
                                                </div>
                        ...
                        <form action="{{ route('bukus.store') }}" method="POST">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 mb-3">
                                        <label for="berat" class="form-label">Berat (kg)</label>
                                        <input type="number" class="form-control" name="berat" step="0.01"
                                            min="0" required>
                                        <!-- Memungkinkan input berat desimal -->
                                    </div>
                                </div>
