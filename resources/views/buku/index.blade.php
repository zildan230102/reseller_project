                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p><strong>Berat:</strong> {{ number_format($buku->berat / 1000, 2) }} kg</p>
                        ...
                        <form action="{{ route('bukus.update', $buku->id) }}" method="POST">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" name="berat" value="{{ $buku->berat }}" required>
                                </div>
                                <div class="mb-3">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form action="{{ route('bukus.destroy', $buku->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="custom-button">Hapus</button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ route('bukus.store') }}" method="POST">
                ...
                <div class="modal-footer">
                    <button type="submit" class="custom-button">Tambah</button>
                </div>
            </form>
        </div>
    </div>
