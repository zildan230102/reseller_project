            ...
            <nav class="navbar navbar-expand navbar-light">
                ...
                <div class="container">
                    <ul class="nav nav-pills">
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown" id="pembayaranDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                Pembayaran
                            </a>
                    ...
                    <ul class="navbar-nav navbar-align">
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                                <img src="{{ ('style/src/img/avatars/avatar.jpg') }}" class="avatar img-fluid rounded me-1" alt="Jenny Wilson" />
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item text-danger" href="#">
                                    ...
                                    <span class="align-middle me-1"></span> Logout
                                </a>
                            </div>
                        </li>
                    </ul>
